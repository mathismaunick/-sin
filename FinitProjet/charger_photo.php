...
<?php
  ...
  #	$sql = "INSERT INTO images (image, image_text) VALUES ('$image', '$image_text')";
    $sql = "INSERT INTO `publication` (`idPublication`, `idMembre`, `type`,`nbCom`,`nbLike`,`datePublication`) VALUES (NULL, '$id', 2,0,0,'$datePublication')";
    mysqli_query($db, $sql);
    ...
    while ($tutu = mysqli_fetch_array($kiki)) {
  	...
  	$sql = "INSERT INTO `photos` (`idPhoto`, `Description`, `lieu`, `idPublication`, `lien`) VALUES (NULL, '$image_text', '', $pipi, '$image')";
...
<br><br><br><br>
  <form method="POST" action="charger_photo.php" enctype="multipart/form-data">
